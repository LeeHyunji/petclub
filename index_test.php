...
<body>
		...
		<div class="header-menu">
			<div class="container">
				<div class="header-content-v8">
					...
					<nav>
						<ul>
							<li><a class="active" href="about.html" title="펫클럽 소개">펫클럽 소개</a>
							</li>
							<li><a href="brand.html" title="브랜드">브랜드</a>
								<ul>
									<li><a href="14_portfolio_parallax.html" title="">Portfolio Parallax</a></li>
									<li><a href="15_portfolio_horizontal_scroll.html" title="">Portfolio Horizontol</a></li>
									<li><a href="16_portfolio_masonry.html" title="">Portfolio Masonary</a></li>
									<li><a href="17_portfolio_single_layout_1.html" title="">Portfolio Single Layout V1</a></li>
									<li><a href="18_portfolio_single_layout_2.html" title="">Portfolio Single Layout V2</a></li>
									<li><a href="19_portfolio_single_layout_3.html" title="">Portfolio Single Layout V3</a></li>
								</ul>
							</li>
							<li><a href="/map" title="매장소개">매장소개</a>
								<ul>
									<li><a href="blog-layout1.html" title="">Blog V1</a></li>
									<li><a href="blog-layout2.html" title="">Blog V2</a></li>
									<li><a href="blog-single-layout1.html" title="">Blog Single V1</a></li>
									<li><a href="blog-single-layout2.html" title="">Blog Single V2</a></li>
								</ul>
							</li>
							<li><a href="franchise-01.html" title="가맹정보">가맹정보</a>
								<ul>
									<li><a href="franchise-01.html" title="가맹소개">가맹소개</a></li>
									<li><a href="franchise-02.html" title="수익구조">수익구조</a></li>
									<li><a href="franchise-03.html" title="비용 및 절차">비용 및 절차</a></li>
									<li><a href="franchise-04.html" title="창업문의">창업문의</a></li>
								</ul>
							</li>
							<li><a href="board.html" title="뉴스&이벤트">뉴스&이벤트</a>
								<ul>
									<li><a href="board.html" title="펫클럽 뉴스">펫클럽 뉴스</a></li>
									<li><a href="board.html" title="펫클럽 이벤트">펫클럽 이벤트</a></li>
								</ul>
							</li>
						</ul>
					</nav><!--nav end-->
	...
	<div class="responsive-menu">
		<div class="rep-header">
			<div class="rep-logo">
				<img src="assets/image/petclub_logo_2.png" alt="">
			</div>
		...
		<ul class="mobile-menu">
			...
			<li><a href="about.html" title="펫클럽소개">펫클럽소개</a>
			</li>
			<li><a href="brand.html" title="브랜드">브랜드</a>
				<ul>
					<li><a href="14_portfolio_parallax.html" class="animsition-link" data-animsition-out-class="fade-out" title="" data-text="Porfolio Parallax">Porfolio Parallax</a></li>
					<li><a href="15_portfolio_horizontal_scroll.html" class="animsition-link" data-animsition-out-class="fade-out" title="" data-text="Porfolio Horizontal Scroll">Porfolio Horizontal Scroll</a></li>
					<li><a href="16_portfolio_masonry.html" title="">Porfolio Masonary</a></li>
					<li><a href="17_portfolio_single_layout_1.html" class="animsition-link" data-animsition-out-class="fade-out" title="" data-text="Porfolio Single V1">Porfolio Single V1</a></li>
					<li><a href="18_portfolio_single_layout_2.html" class="animsition-link" data-animsition-out-class="fade-out" title="" data-text="Porfolio Single V2">Porfolio Single V2</a></li>
					<li><a href="19_portfolio_single_layout_3.html" class="animsition-link" data-animsition-out-class="fade-out" title="" data-text="Porfolio Single V3">Porfolio Single V3</a></li>
				</ul>
			</li>
			<li><a href="/map" title="매장소개">매장소개</a>
				<ul>
					<li><a href="27_service_1.html" class="animsition-link" data-animsition-out-class="fade-out" title="" data-text="Service V1">Service V1</a></li>
					<li><a href="28_services_2.html" class="animsition-link" data-animsition-out-class="fade-out" title="" data-text="Service V2">Service V2</a></li>
					<li><a href="29_services_3.html" class="animsition-link" data-animsition-out-class="fade-out" title="" data-text="Service V3">Service V3</a></li>
				</ul>
			</li>
			<li><a href="franchise-01.html" title="">가맹정보</a>
				<ul>
					<li><a href="franchise-01.html" class="animsition-link" data-animsition-out-class="fade-out" title="" data-text="가맹소개">가맹소개</a></li>
					<li><a href="franchise-01.html" class="animsition-link" data-animsition-out-class="fade-out" title="" data-text="수익구조">수익구조</a></li>
					<li><a href="franchise-01.html" class="animsition-link" data-animsition-out-class="fade-out" title="" data-text="비용 및 절차">비용 및 절차</a></li>
					<li><a href="franchise-01.html" class="animsition-link" data-animsition-out-class="fade-out" title="" data-text="창업문의">창업문의</a></li>
				</ul>
			</li>
			<li><a href="board.html" title="뉴스&이벤트">뉴스&이벤트</a>
				<ul>
					<li><a href="board.html" class="animsition-link" data-animsition-out-class="fade-out" title="" data-text="펫클럽 뉴스">펫클럽 뉴스</a></li>
					<li><a href="board.html" class="animsition-link" data-animsition-out-class="fade-out" title="" data-text="펫클럽 이벤트">펫클럽 이벤트</a></li>
				</ul>
			</li>
		</ul>
			...
			<div class="swiper main-banner-swiper">
				...
				<div class="swiper-wrapper">
                    <?php
                        ...
                        $sql = "select * from user_content where gubun = 'M' ";
					...
					<div class="row">
						...
						<div class="col-12 col-md-6">
							<div class="card-feature">
								...
								<div class="card-body">
									...
									<p>업게 최대 규모의 <strong>오프라인 30만 회원 공유</strong>로 
										포인트 통합 활용</p>
								</div>
							</div>
						</div>
						...
						<div class="col-12 col-md-6">
							<div class="card-feature">
								...
								<div class="card-body">
									<h5 class="card-title">체게적인 관리 시스템</h5>
			...
			<div class="sec-content">
				<div class="container-fluid">
					<div class="swiper main-store-swiper">
						<div class="swiper-wrapper">
							...
							<div class="swiper-slide">
								...
								<h5><?= $row["CONTENT"] ?><b><?= $row["CONTENT_2"] ?></b></h5>
					...
					<div class="more-button">
						<a href="#" class="btn-store-more">지방과 수도권의 매출 차이가
				...
				<div class="swiper main-review-swiper">
					<div class="swiper-wrapper">
						...
						<div class="swiper-slide card-review">
							...
							<div class="card-body">
								<h6>반려동물용품점, 선택과 집중으로 성공!</h6>
								<p>안녕하세요. 8개월차 창업초보 김현아입니다. 처음 창업을 마음먹었을때, 여러가지 생각은 많았지만, 기존에 팻클럽을 애용했던 고객으로써 '펫클럽' 브랜드를 통해 좋은 느낌을 받았었습니다. '딱 이거다!'라고 확신을 가진 순간, 큰 고민은 없었습니다. 매장을 방문해주시는 고객분들 중에 리뷰리뷰리뷰 리뷰리뷰리뷰 리뷰리뷰리뷰 리뷰리뷰리뷰 리뷰리뷰리뷰 리뷰리뷰리뷰</p>
								<div class="more-button">
									<a href="#" class="btn-review-more">더보기</a>
								</div>
							</div>
						</div>
						<div class="swiper-slide card-review">
						...
						<div class="swiper-slide card-review">
							<div class="card-head">
								...
								<div class="card-head-img">
									<img src="assets/image/user_04.png" alt="리뷰">
								</div>	
							</div>
							<div class="card-body">
								<h6>반려동물용품점, 선택과 집중으로 성공!</h6>
						...
						<div class="swiper-slide card-review">
							<div class="card-head">
								...
								<div class="card-head-img">
									<img src="assets/image/user_05.png" alt="리뷰">
								</div>	
							</div>
							<div class="card-body">
								<h6>반려동물용품점, 선택과 집중으로 성공!</h6>
			...
			<div class="container">
				...
				<div class="sec-content">
					<ul class="keywords-list">
						<li class="keywords-item"><a href="#">#창업 프로세스</a></li>
						<li class="keywords-item"><a class="active" href="#">#포스 데이터</a></li>
						<li class="keywords-item"><a href="#">#창업 비용</a></li>
						<li class="keywords-item"><a href="#">#성공 사례</a></li>
					</ul>
				</div>
			</div>
		</section>
...
<script>
	...
	const main_banner_buttons = ["업계 1위 대박 매출","부담없는 자본금","전국 방방곡곡 매장","재방문율 높은 오프라인 회원"];
